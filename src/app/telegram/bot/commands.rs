use crate::app::telegram::bot::bind::handler::TelegramBotBindCommandHandler;
use crate::app::telegram::bot::context::TelegramBotCommandContext;
use crate::app::telegram::bot::login::handler::TelegramBotLoginCommandHandler;
use crate::app::telegram::bot::start::handler::TelegramBotStartCommandHandler;
...
pub async fn handle(
    ...
    match *cmd {
        ...
        Command::Bind => {
            TelegramBotBindCommandHandler::new(context)
                .execute()
                .await?;
        }
        Command::Login => {
            TelegramBotLoginCommandHandler::new(context)
                .execute()
                .await?;
        }
    }
