...
impl FromStr for GithubEventType {
    ...
    fn from_str(external_string: &str) -> Result<Self, Self::Err> {
        match external_string {
            ...
            "pull_request_review" => Ok(GithubEventType::PullRequestReview),
            "pull_request_review_comment" => Ok(GithubEventType::PullRequestReviewComment),
            "issue_comment" => Ok(GithubEventType::IssueComment),
...
impl From<GithubEventType> for WebhookEventType {
    fn from(event: GithubEventType) -> Self {
        match event {
            ...
            GithubEventType::PullRequestReview => WebhookEventType::PullRequestReview,
            GithubEventType::PullRequestReviewComment => WebhookEventType::PullRequestReviewComment,
            GithubEventType::IssueComment => WebhookEventType::IssueComment,
