...
#[derive(Debug, Error)]
pub enum UpdateHealthPingExecutorError {
...
impl From<FindHealthPingError> for UpdateHealthPingExecutorError {
...
impl From<UpdateHealthPingError> for UpdateHealthPingExecutorError {
