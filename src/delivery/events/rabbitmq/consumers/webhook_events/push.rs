...
pub struct RabbitMQWebhookPushConsumer {
...
#[async_trait]
impl EventConsumer for RabbitMQWebhookPushConsumer {
    type EventPayload = WebhookPushEvent;
    ...
    async fn handle(&self, payload: WebhookPushEvent) -> Result<(), EventConsumerError> {
